...
function winningTeam(){
    ...
    return (homeTotalPoint>awayTotalPoint?`${obj.home.teamName} is the winner.`:`${obj.away.teamName} is the winner.`);
}
...
function doesLongNameStealATon(){
    ...
    const steals=obj.home.players[longestName]!=undefined?obj.home.players[longestName]:obj.away.players[longestName].steals;
    for(let team in obj){
        for(let player in obj[team].players){
